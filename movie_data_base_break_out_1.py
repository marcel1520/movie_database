    ...
    if len(movies_dict) == 0:
        ...
        def get_average():
            ...
            for val in movies_dict.values():
                val_list.append(val)
                average_rating = sum(val_list) / len(val_list)
        ...
        def get_best_worst_ratings(list_of_vals):
            ...
            print_info_best = f"Best movie: {best_list[0]}, {best_list[1]}"
            print_info_worst = f"Worst movie: {worst_list[0]}, {worst_list[1]}\n"
...
def get_user_input():
    ...
    if user_menu_choice == 1:
        print(f"\n{len(movies_dict)} movies in Database\n")
        option_1 = option_1_movie_display(movies_dict)
        return option_1
    elif user_menu_choice == 2:
        option_2 = option_2_movie_adding(movies_dict)
        return option_2
    elif user_menu_choice == 3:
        option_3 = option_3_movie_delete(movies_dict)
        return option_3
    elif user_menu_choice == 4:
        option_4 = option_4_movie_update(movies_dict)
        return option_4
    elif user_menu_choice == 5:
        option_5 = option_5_get_stats()
        return option_5
    elif user_menu_choice == 6:
        option_6 = option_6_pick_random_movie(movies_dict)
        return option_6
    elif user_menu_choice == 7:
        option_7 = option_7_search_movie(movies_dict)
        return option_7
    elif user_menu_choice == 8:
        option_8 = option_8_sort_dict_by_rating(movies_dict)
        return option_8
    else:
...
def continue_or_break_out():
    users_choice = input("Do you want to continue? (y/n) ")
    if users_choice == "y":
        main()
    elif users_choice == "n":
        print("thank you for using the Movies Database")
    else:
        print("please enter y or n ")
        continue_or_break_out()
    return users_choice
